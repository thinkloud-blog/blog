	...
	?>
		<?php if ( comments_open( $post_id ) ) : ?>
			...
			<div id="respond" class="comment-respond">
				<p id="reply-title" class="h3 comment-reply-title"><?php comment_form_title( $args['title_reply'], $args['title_reply_to'] ); ?> <small><?php cancel_comment_reply_link( $args['cancel_reply_link'] ); ?></small></P>
